  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="{{ Storage::url($jumbotron->thumbnail) }}" alt="{{ $jumbotron->thumbnail }}" />
        <!-- Masthead Heading-->
          ...
          <?php $no = 1; foreach ($partner as $p) : ?>
            <!-- Partner Item {{ $no }}-->
              <div class="col-md-6 col-lg-4 mb-5">
                <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{ $no }}">
                  <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                    <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                  </div>
                  <img class="img-fluid" src="{{ Storage::url($p->thumbnail) }}" alt="{{ $p->thumbnail }}" />
                </div>
              </div>
            <!-- last partner {{ $no }}-->
          <?php $no++; endforeach; ?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @if ($youtube)
              <a class="btn btn-outline-light btn-social mx-1" href="{{ $youtube }}" target="_blank"><i class="fab fa-fw fa-youtube"></i></a>
            @endif
            @if($instagram)
              <a class="btn btn-outline-light btn-social mx-1" href="{{ $instagram }}" target="_blank"><i class="fab fa-fw fa-instagram"></i></a>
            @endif
            @if($twitter)
              <a class="btn btn-outline-light btn-social mx-1" href="{{ $twitter }}" target="_blank"><i class="fab fa-fw fa-twitter"></i></a>
            @endif
            @if($facebook)
              <a class="btn btn-outline-light btn-social mx-1" href="{{ $facebook }}" target="_blank"><i class="fab fa-fw fa-facebook-f"></i></a>
            @endif
          </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
    ...
    <?php $no = 1; foreach ($partner as $p) : ?>
      <!-- Partner Modal {{ $no }}-->
      <div class="portfolio-modal modal fade" id="portfolioModal{{ $no }}" tabindex="-1" aria-labelledby="portfolioModal1" aria-hidden="true">
            ...
            <div class="modal-body text-center pb-5">
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    <!-- Partner Modal - Title-->
                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">{{ $p->title }}</h2>
                    <!-- Icon Divider-->
                    <div class="divider-custom">
                      <div class="divider-custom-line"></div>
                      <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                    ...
                    <!-- Partner Modal - Image-->
                    <img class="img-fluid rounded mb-5" src="{{ Storage::url($p->thumbnail) }}" alt="{{ $p->thumbnail }}" />
                    <br>
                    <!-- Partner Modal - Text-->
                    {!! $p->content !!}
                    <div class="m-5">
